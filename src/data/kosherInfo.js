...
import nahariyaRabbinateIcon from '../assets/icons/kosher/nahariya-rabbinate.svg'
...
export const kosherRows = [
  ...
  // Round "under supervision of the Nahariya Rabbinate" seal — text is baked
  // into the artwork itself, so this row is used icon-only (no line1/line2).
  { id: 'nahariyaRabbinate', icon: nahariyaRabbinateIcon, iconWidth: 88, iconHeight: 88, invertOnHighContrast: true },
]
